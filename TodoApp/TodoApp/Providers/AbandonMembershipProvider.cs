...
public class AbandonMembershipProvider : MembershipProvider
{
    ...
    public override MembershipUser CreateUser(
        ...
        out MembershipCreateStatus status) => throw new NotImplementedException();
    ...
    public override string GetPassword(
        string username,
        string answer) => throw new NotImplementedException();
    ...
    public override void UpdateUser(
        MembershipUser user) => throw new NotImplementedException();
    ...
    public override MembershipUser GetUser(
        object providerUserKey,
        bool userIsOnline) => throw new NotImplementedException();
    ...
    public override bool DeleteUser(
        string username,
        bool deleteAllRelatedData) => throw new NotImplementedException();
